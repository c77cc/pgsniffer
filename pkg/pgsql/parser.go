...
func (p *Parser) Parse(bytes []byte) (complete bool, err error) {
	if len(bytes) < 6 {
...
func (p *Parser) parseSimpleQuery(pmsg *PgsqlMessage) {
...
func (p *Parser) parseRowDescription(pmsg *PgsqlMessage) {
	// Ignore row desc msg.
	msg := p.cutTopMsg()
	if msg == nil {
...
func (p *Parser) parseEmptyQueryResponse(pmsg *PgsqlMessage) {
}

func (p *Parser) parseCommandComplete(pmsg *PgsqlMessage) {
	msg := p.cutTopMsg()
	if msg == nil {
...
func (p *Parser) parseReadyForQuery(pmsg *PgsqlMessage) {
}

func (p *Parser) parseErrorResponse(pmsg *PgsqlMessage) {
	pmsg.readError()
...
func (p *Parser) parseParameterStatus(pmsg *PgsqlMessage) {
	msg := p.cutTopMsg()
	if msg == nil {
		log.Println("cannot cut a pgsql msg 'C'.")
		return
...
func (p *Parser) parseParse(pmsg *PgsqlMessage) {
...
func (p *Parser) parseParseComplete(pmsg *PgsqlMessage) {
	msg := p.cutTopMsg()
	if msg == nil {
...
func (p *Parser) parseBind(pmsg *PgsqlMessage) {
	_, err := pmsg.readNullTerString()
	if err != nil {
		log.Println(err.Error())
		return
...
func (p *Parser) parseBindComplete(pmsg *PgsqlMessage) {
...
func (p *Parser) appendMsg(msg *PgsqlMessage) {
	p.mux.Lock()
	p.msgs = append(p.msgs, msg)
	p.mux.Unlock()
}

func (p *Parser) cutTopMsg() (msg *PgsqlMessage) {
	if len(p.msgs) < 1 {
		return
	}
	p.mux.Lock()
